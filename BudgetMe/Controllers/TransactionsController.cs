...
namespace BudgetMe.Controllers
{
    ...
    public class TransactionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Amount,Description,TransactionType,CreatedAt,UpdatedAt,UserId")] Transaction transaction)
        {
            ...
            {
                transaction.UserId = AppUserManager.GetUser().Id;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Amount,Description,TransactionType,CreatedAt,UpdatedAt,UserId")] Transaction transaction)
        {
            if (ModelState.IsValid)
            {
